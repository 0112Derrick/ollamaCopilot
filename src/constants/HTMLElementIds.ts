const HTML_IDS = {
  ...
  EMBED_FILE_BUTTON: "addFileButtonEmbed",
  SYSTEM_PROMPT: "user_systemPrompt",
  DIV_DOCS_TO_EMBED_CONTAINER: "docsToEmbedContainer",
  SAVE_EMBEDDED_DOCS_BUTTON: "saveEmbeddedDocs",
  CONTAINER: "container",
